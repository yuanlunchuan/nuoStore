...
<ul>
<li>
  <div class="pic"><img src="<%=baseUrl %>/static/images/01.png" width="245" height="196" alt=""/></div>
  <div class="txt"><p><i class="icon-jifen"></i>积分500<a href="#">兑换</a></p><span>诺康薏仁紫苏</span></div>
</li>
<li>
  <div class="pic"><img src="<%=baseUrl %>/static/images/02.png" width="245" height="196" alt=""/></div>
  <div class="txt"><p><i class="icon-jifen"></i>积分500<a href="#">兑换</a></p><span>益生菌</span></div>
</li>
<li>
  <div class="pic"><img src="<%=baseUrl %>/static/images/03.png" width="245" height="196" alt=""/></div>
  <div class="txt"><p><i class="icon-jifen"></i>积分500<a href="#">兑换</a></p><span>柯氏发酵冬虫夏草胶囊</span></div>
</li>
<li>
  <div class="pic"><img src="<%=baseUrl %>/static/images/04.png" width="245" height="196" alt=""/></div>
  <div class="txt"><p><i class="icon-jifen"></i>积分500<a href="#">兑换</a></p><span>均衡营养特膳</span></div>
</li>
</ul>
</div>
</div>
